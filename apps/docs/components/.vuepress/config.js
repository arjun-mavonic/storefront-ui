...
const reactMenu = [
  ...
  },
  {
    title: 'Pages',
    collapsable: true,
    children: [['/react/pages', 'Overview'], ...convertComponentPathsToLinks(pages.vue, 'react', 'pages')],
  },
  {
    title: 'Community',
    collapsable: true,
...
const vueMenu = [
  ...
  },
  {
    title: 'Pages',
    collapsable: true,
    children: [['/vue/pages', 'Overview'], ...convertComponentPathsToLinks(pages.vue, 'vue', 'pages')],
  },
  {
    title: 'Community',
    collapsable: true,
...
module.exports = {
  ...
  patterns: ['**/*.md', '**/*.vue', '!components/**/*.md', '!blocks/**/*.md', '!pages/**/*.md', '!hooks/**/*.md'], // ignore components folder
  patterns: [
    '**/*.md',
    '**/*.vue',
    '!components/**/*.md',
